...
def exp_details(args):
    ...
    print(f"  Rounds: {int(args.rounds)}")
    print(f"  L_rate: {args.lr}")
    print(f"  Total number of users: {int(args.num_users)}")
    print(f"  Fraction of users: {float(args.frac)}")
    print(f"  Local batch size: {int(args.local_bs)}")
    print(f"  Local epochs: {int(args.local_ep)}\n")
    print(f"Running...\n")
